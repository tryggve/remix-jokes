...
import { Form, json, Link, redirect, useActionData, useCatch, useTransition } from 'remix'
...
export default function NewJokesRoute() {
    ...
    if (transition.submission) {
        ...
        if (typeof name === 'string' && typeof content === 'string' && !validateJokeName(name) && !validateJokeContent(content)) {
            return (
